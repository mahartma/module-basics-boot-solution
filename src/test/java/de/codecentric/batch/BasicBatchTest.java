...
@SpringApplicationConfiguration(classes = {DummyJobExecuter.class, BatchTestConfiguration.class})
...
public class BasicBatchTest {
	...
	public void sollteBatchStarten() throws Exception {
		...
		assertThat(jobExecution.getStepExecutions().iterator().next().getCommitCount(), is(2));
	}
}
